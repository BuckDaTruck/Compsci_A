...
public class Unit4Project {
    ...
    public static int choice() {
        ...
        System.out.println("2. Provide the overall highest, lowest temperature and average temperature for a particular month.");
    ...
    public static void hlaYear(int[][] hla, int days, int[] hlaYear) {
        ...
        hlaYear[2] = temp / days;
        System.out.print("High " + hlaYear[0]);
        System.out.print(" Low " + hlaYear[1]);
        System.out.println(" Average " + hlaYear[2]);
    }
